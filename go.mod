module github.com/Christian-CC/weekendr-core

go 1.25.0

require (
	github.com/stretchr/testify v1.11.1
	t-shaped.nl/sushitrain/v2 v2.0.0
)
...
require (
	...
	github.com/syncthing/syncthing v1.30.0-rc.1.0.20260211104138-dc2a77ab8e5b // indirect
...
replace (
	github.com/gobwas/glob v0.2.3 => github.com/calmh/glob v0.0.0-20220615080505-1d823af5017b
	t-shaped.nl/sushitrain/v2 => ./SushitrainCore
)
